# Generated by Django 3.1.3 on 2021-04-07 11:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='DjangoReview',
            fields=[
                ('id_django_review', models.AutoField(primary_key=True, serialize=False)),
                ...
                ('id_user', models.ForeignKey(db_column='id_user', on_delete=django.db.models.deletion.CASCADE, to='recommendations.djangouser')),
            ],
            options={
